...
class ATSCTables
{
    public const L1B_CELLS_FIXED = 3820;

    public static array $TABLE_7_2_PREAMBLE = [
        "8K" => [
    ...
    public static array $GI_VALUE_TO_SAMPLES = [
        1 => 192, 2 => 384, 3 => 512, 4 => 768, 5 => 1024,
        6 => 1536, 7 => 2048, 8 => 2432, 9 => 3072, 10 => 3648,
        11 => 4096, 12 => 4864,
    ];

    public static array $FFT_VALUE_TO_NAME = [
        0 => "8K", 1 => "16K", 2 => "32K",
    ];

    public static array $TABLE_7_3 = [
        "8K" => [
    ...
    public static array $SBS_ACTIVE_DATA_CELLS = [
        0 => [
    ...
    public static array $SP_PATTERN_MAP = [
